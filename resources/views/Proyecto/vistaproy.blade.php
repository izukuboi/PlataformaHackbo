...
<div id="wrapper-header">
	<div id="main-header" class="object">
		<!--<div class="logo"><img src="{{asset('img/logo-burst.png')}}" alt="logo platz" height="60" width="90"></div>
...
<!-- PORTFOLIO -->
	...
	<div id="wrapper-container">
		...
		<div class="container object">
			...
			<!--			<figure class="white">
							<a href="#">
								<img src="{{asset('img/font-1.jpg')}}" alt="" />
								<dl>
									<dt>Free font</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="{{asset('img/icon-font.svg')}}" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/psd-1.jpg')}}" alt="" />
								<dl>
									<dt>PSD Goodies</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="{{asset('img/icon-psd.svg')}}" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/psd-2.jpg')}}" alt="" />
								<dl>
									<dt>PSD Goodies</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/ai-1.jpg')}}" alt="" />
								<dl>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="{{asset('img/icon-ai.svg')}}" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/theme-2.jpg')}}" alt="" />
								<dl>
									<dt>Html theme</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="{{asset('img/icon-themes.svg')}}" alt="" width="28" height="28"/></div>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/psd-3.jpg')}}" alt="" />
								<dl>
									<dt>PSD goodies</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/font-2.jpg')}}" alt="" />
								<dl>
									<dt>Free font</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/font-3.jpg')}}" alt="" />
								<dl>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/ai-2.jpg')}}" alt="" />
								<dl>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/icons-1.jpg')}}" alt="" />
								<dl>
									<dt>PSD icons</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/ui-1.jpg')}}" alt="" />
								<dl>
									<dt>UI design</dt>
                            ...
                            <div id="wrapper-part-info">
                            	<div class="part-info-image"><img src="{{asset('img/icon-premium.svg')}}" alt="" width="28" height="28"/></div>
                        ...
                        <figure class="white">
							<a href="#">
								<img src="{{asset('img/font-5.jpg')}}" alt="" />
								<dl>
									<dt>Free font</dt>
									<dd>A set of 6 outline beer icons created with Adobe Illustrator. Free Ai designed and released by Justas Galaburda.</dd>
								</dl>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/psd-5.jpg')}}" alt="" />
								<dl>
									<dt>PSD mockup</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/icons-3.jpg')}}" alt="" />
								<dl>
									<dt>PSD icons</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/font-4.jpg')}}" alt="" />
								<dl>
									<dt>Free font</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/theme-3.jpg')}}" alt="" />
								<dl>
									<dt>HTML theme</dt>
						...
						<figure class="white">
							<a href="#">
								<img src="{{asset('img/font-6.jpg')}}" alt="" />
								<dl>
									<dt>Free font</dt>
